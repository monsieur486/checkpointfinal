 ...
 */
final class Version20200130091756 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE circuit (id INT AUTO_INCREMENT NOT NULL, date_presentation DATE NOT NULL, ville VARCHAR(255) NOT NULL, places INT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
